...
/***/ function(module, exports, __webpack_require__) {
	...
	var playSquare = function playSquare(event) {
	  event.preventDefault();
	  var id = $(event.target).parents().parents().attr("id");
	  app.game.index = id;
	  cellsFull += 1;
	  if (gameNumber % 2 === 0) {
	    if (cellsFull % 2 === 0) {
	  ...
	  api.playSquare().done(ui.playSuccess).fail(ui.failure);
	};
	...
	var createGame = function createGame(event) {
	  ...
	  api.createGame().done(ui.gameCreated).fail(ui.failure);
	  for (var i = 0; i <= 9; i++) {
	    currentGame.pop();
	  }
	  cellsFull = 0;
	...
	var onGames = function onGames() {
	  api.showGames().done(ui.showWins).fail(ui.failure);
	};

	var getStats = function getStats(event) {
	  event.preventDefault();
	  api.showGames().done(ui.showStats).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var playSquare = function playSquare() {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameCreated = function gameCreated(data) {
	  $('#create-game').hide();
	  $('.board').show();
	  $('.scoreboard').show();
	  ...
	  api.showGames().done(showGames).done(showWins).fail(failure);
	};
	...
	var showStats = function showStats(data) {
	  ...
	  if (lastGame.cells[0] !== undefined && lastGame.cells[0] === lastGame.cells[1] && lastGame.cells[1] === lastGame.cells[2]) {
	    player = lastGame.cells[0];
	  } else if (lastGame.cells[0] !== undefined && lastGame.cells[0] === lastGame.cells[3] && lastGame.cells[3] === lastGame.cells[6]) {
	    player = lastGame.cells[0];
	  } else if (lastGame.cells[0] !== undefined && lastGame.cells[0] === lastGame.cells[4] && lastGame.cells[4] === lastGame.cells[8]) {
	    player = lastGame.cells[0];
	  } else if (lastGame.cells[2] !== undefined && lastGame.cells[2] === lastGame.cells[5] && lastGame.cells[5] === lastGame.cells[8]) {
	    player = lastGame.cells[2];
	  } else if (lastGame.cells[2] !== undefined && lastGame.cells[2] === lastGame.cells[4] && lastGame.cells[4] === lastGame.cells[6]) {
	    player = lastGame.cells[2];
	  } else if (lastGame.cells[1] !== undefined && lastGame.cells[1] === lastGame.cells[4] && lastGame.cells[4] === lastGame.cells[7]) {
	    player = lastGame.cells[1];
	  } else if (lastGame.cells[3] !== undefined && lastGame.cells[3] === lastGame.cells[4] && lastGame.cells[4] === lastGame.cells[5]) {
	    player = lastGame.cells[3];
	  } else if (lastGame.cells[6] !== undefined && lastGame.cells[6] === lastGame.cells[7] && lastGame.cells[7] === lastGame.cells[8]) {
	  ...
	  var xPlays = 0;
	  var oPlays = 0;
	  for (var _i = 0; _i < lastGame.cells.length; _i++) {
	    if (lastGame.cells[_i] === 'x') {
	      xPlays += 1;
	    }
	    if (lastGame.cells[_i] === 'o') {
	      oPlays += 1;
	    };
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var countSquares = function countSquares(gameArray) {
	  var result = 0;
	...
	var logic = function logic(gameArray) {
	  if (gameArray[0] !== undefined && gameArray[0] === gameArray[1] && gameArray[1] === gameArray[2]) {
	  ...
	  } else if (gameArray[0] !== undefined && gameArray[0] === gameArray[3] && gameArray[3] === gameArray[6]) {
	    $('.board').delay(1200).hide();
	    if (gameArray[0] === 'x') {
	      $('.x-wins').show().delay(1200).fadeOut(900);
	      xWins += 1;
	    ...
	    $('#0, #1, #2, #3, #4, #5, #6, #7, #8').off('click', events.playSquare);
	    api.gameOver().done(ui.gameOver).fail(ui.failure);
	  } else if (gameArray[0] !== undefined && gameArray[0] === gameArray[4] && gameArray[4] === gameArray[8]) {
	    $('.board').delay(1200).hide();
	    if (gameArray[0] === 'x') {
	      $('.x-wins').show().delay(1200).fadeOut(900);
	      xWins += 1;
	    ...
	    $('#0, #1, #2, #3, #4, #5, #6, #7, #8').off('click', events.playSquare);
	    api.gameOver().done(ui.gameOver).fail(ui.failure);
	  } else if (gameArray[2] !== undefined && gameArray[2] === gameArray[5] && gameArray[5] === gameArray[8]) {
	    $('.board').delay(1200).hide();
	    if (gameArray[2] === 'x') {
	      $('.x-wins').show().delay(1200).fadeOut(900);
	      xWins += 1;
	    ...
	    $('#0, #1, #2, #3, #4, #5, #6, #7, #8').off('click', events.playSquare);
	    api.gameOver().done(ui.gameOver).fail(ui.failure);
	  } else if (gameArray[2] !== undefined && gameArray[2] === gameArray[4] && gameArray[4] === gameArray[6]) {
	    $('.board').delay(1200).hide();
	    if (gameArray[2] === 'x') {
	      $('.x-wins').show().delay(1200).fadeOut(900);
	      xWins += 1;
	    ...
	    $('#0, #1, #2, #3, #4, #5, #6, #7, #8').off('click', events.playSquare);
	    api.gameOver().done(ui.gameOver).fail(ui.failure);
	  } else if (gameArray[1] !== undefined && gameArray[1] === gameArray[4] && gameArray[4] === gameArray[7]) {
	    $('.board').delay(1200).hide();
	    if (gameArray[1] === 'x') {
	      $('.x-wins').show().delay(1200).fadeOut(900);
	      xWins += 1;
	    ...
	    $('#0, #1, #2, #3, #4, #5, #6, #7, #8').off('click', events.playSquare);
	    api.gameOver().done(ui.gameOver).fail(ui.failure);
	  } else if (gameArray[3] !== undefined && gameArray[3] === gameArray[4] && gameArray[4] === gameArray[5]) {
	    $('.board').delay(1200).hide();
	    if (gameArray[3] === 'x') {
	      $('.x-wins').show().delay(1200).fadeOut(900);
	      xWins += 1;
	    ...
	    $('#0, #1, #2, #3, #4, #5, #6, #7, #8').off('click', events.playSquare);
	    api.gameOver().done(ui.gameOver).fail(ui.failure);
	  } else if (gameArray[6] !== undefined && gameArray[6] === gameArray[7] && gameArray[7] === gameArray[8]) {
	    $('.board').delay(1200).hide();
	    if (gameArray[6] === 'x') {
	      $('.x-wins').show().delay(1200).fadeOut(900);
	      xWins += 1;
